...
from .decoder_seg import UnetPlusPlusDecoder_seg
...
class UnetPlusPlus(SegmentationModel):
    ...
    def __init__(
        ...
        # self.decoder_inpainting = UnetPlusPlusDecoder(
        #     encoder_channels=self.encoder.out_channels,
        #     decoder_channels=decoder_channels,
        #     n_blocks=encoder_depth,
        #     use_batchnorm=decoder_use_batchnorm,
        ...
        # )
        #
        # self.decoder_segmentation = UnetPlusPlusDecoder_seg(
        #     encoder_channels=self.encoder.out_channels,
        #     decoder_channels=decoder_channels,
        #     n_blocks=encoder_depth,
        #     use_batchnorm=decoder_use_batchnorm,
        ...
        #     in_channels=decoder_channels[-1],
        #     out_channels=inpainting_classes,
        #     activation=activation,
        #     kernel_size=3,
        # )
        #
